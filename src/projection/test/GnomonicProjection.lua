...
log.tic()
unit_coords = gp:angles_to_normalized_coords(angles)
time = log.toc()
printf(" - Time Gnomonic angles to normalized_coords")
printf("   %2.4fs, %2.4es per px", time, time*perElement)
log.tic()
unit_coords_rp = rp:angles_to_normalized_coords(angles_rp)
time = log.toc()
printf(" - Time Rectilinear angles to normalized_coords")
printf("   %2.4fs, %2.4es per px", time, time*perElement)
log.tic()
unit_angles = gp:normalized_coords_to_angles(unit_coords)
time = log.toc()
printf(" - Time Gnomonic normalized_coords to angles")
printf("   %2.4fs, %2.4es per px", time, time*perElement)
...
for i,c in ipairs(centers) do
   ...
   angles = gp:angles_map()
   log.tic()
   gp:angles_to_normalized_coords(angles,unit_coords)
   time = log.toc()
   printf(" - Time Gnomonic angles to normalized_coords")
   printf("   %2.4fs, %2.4es per px", time, time*perElement)
   log.tic()
   gp:normalized_coords_to_angles(unit_coords,unit_angles)
   time = log.toc()
   printf(" - Time Gnomonic normalized_coords to angles")
   printf("   %2.4fs, %2.4es per px", time, time*perElement)
