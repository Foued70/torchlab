-- replicate some functionality of original torch image package.
Class()

-- image.Wand = require '../image/Wand'

function load (filename,max_size,colorspace,dimensions)
...
function save (filename,tensor,colorspace,dimensions)
   colorspace = colorspace or "RGB"
   dimensions = dimensions or "DHW"
